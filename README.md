...
- **Sub waves** — waves at 4:00 and 7:00, then one every `20:00 ÷ players` (2:30 with 8 players): the whole bench comes on for whoever has been on longest. Waves are anchored to fixed clock times so late taps don't drift; the last 90s holds unless someone is well under fair share. Everyone finishes within ~1–2 min of fair share.
